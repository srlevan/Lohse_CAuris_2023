...
Micafungin <- subset(P1A6_R, P1A6_R$Drug=="Micafungin" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Micafungin by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Micafungin, Micafungin$Strain == "Strain1537")
Strain1538 <- subset(Micafungin, Micafungin$Strain == "Strain1538")
Strain1539 <- subset(Micafungin, Micafungin$Strain == "Strain1539")
Strain1540 <- subset(Micafungin, Micafungin$Strain == "Strain1540")
Strain1541 <- subset(Micafungin, Micafungin$Strain == "Strain1541")
Strain1542 <- subset(Micafungin, Micafungin$Strain == "Strain1542")
Strain1543 <- subset(Micafungin, Micafungin$Strain == "Strain1543")
Strain1544 <- subset(Micafungin, Micafungin$Strain == "Strain1544")
Strain1545 <- subset(Micafungin, Micafungin$Strain == "Strain1545")
Strain1546 <- subset(Micafungin, Micafungin$Strain == "Strain1546")
Strain1641 <- subset(Micafungin, Micafungin$Strain == "Strain1641")
Strain1642 <- subset(Micafungin, Micafungin$Strain == "Strain1642")
Strain1643 <- subset(Micafungin, Micafungin$Strain == "Strain1643")
Strain124 <- subset(Micafungin, Micafungin$Strain == "Strain124")
StrainB3 <- subset(Micafungin, Micafungin$Strain == "StrainB3")
StrainB8 <- subset(Micafungin, Micafungin$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Micafungin for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Micafungin$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Micafungin$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Micafungin$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Micafungin$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Micafungin$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Micafungin$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Micafungin$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Micafungin$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Micafungin$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Micafungin$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Micafungin$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Micafungin$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Micafungin$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Micafungin$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Micafungin$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Micafungin$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Micafungin$BackgroundCorrect))
...
#Group Strains By Susceptibility to Micafungin
```{r}
...
#Model Each Strain for FlucS and Micafungin
```{r}
...
#Graph the FlucS Strains and Micafungin#
```{r}
GRAPH_Micafungin_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-4,3)+
    xlab("Micafungin (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Micafungin_S
ggsave(filename="GRAPH-Average_Micafungin_S.pdf", plot=GRAPH_Micafungin_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Micafungin_S <- Table
write.table(Table_Micafungin_S,"Table_Micafungin_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Micafungin
```{r}
FlucM
...
#Graph the FlucM Strains and Micafungin#
```{r}
GRAPH_Micafungin_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Micafungin_M
ggsave(filename="GRAPH-Average_Micafungin_M.pdf", plot=GRAPH_Micafungin_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Micafungin_M <- Table
write.table(Table_Micafungin_M,"Table_Micafungin_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Micafungin
```{r}
FlucR
...
#Graph the FlucR Strains and Micafungin#
```{r}
GRAPH_Micafungin_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Micafungin_R
ggsave(filename="GRAPH-Average_Micafungin_R.pdf", plot=GRAPH_Micafungin_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Micafungin_R <- Table
write.table(Table_Micafungin_R,"Table_Micafungin_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Micafungin Graphs
```{r}
Micafungin <- grid.arrange(GRAPH_Micafungin_S,GRAPH_Micafungin_M,GRAPH_Micafungin_R, nrow=1, ncol=3)
ggsave("GRAPH-Micafungin_Fit.pdf", plot=Micafungin, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Micafungin_Table <- rbind(Table_Micafungin_S, Table_Micafungin_M, Table_Micafungin_R)
write.table(Micafungin_Table,"Table_Micafungin.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Micafungin_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
