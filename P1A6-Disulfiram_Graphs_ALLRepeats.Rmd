...
Disulfiram <- subset(P1A6_R, P1A6_R$Drug=="Disulfiram" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Disulfiram by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Disulfiram, Disulfiram$Strain == "Strain1537")
Strain1538 <- subset(Disulfiram, Disulfiram$Strain == "Strain1538")
Strain1539 <- subset(Disulfiram, Disulfiram$Strain == "Strain1539")
Strain1540 <- subset(Disulfiram, Disulfiram$Strain == "Strain1540")
Strain1541 <- subset(Disulfiram, Disulfiram$Strain == "Strain1541")
Strain1542 <- subset(Disulfiram, Disulfiram$Strain == "Strain1542")
Strain1543 <- subset(Disulfiram, Disulfiram$Strain == "Strain1543")
Strain1544 <- subset(Disulfiram, Disulfiram$Strain == "Strain1544")
Strain1545 <- subset(Disulfiram, Disulfiram$Strain == "Strain1545")
Strain1546 <- subset(Disulfiram, Disulfiram$Strain == "Strain1546")
Strain1641 <- subset(Disulfiram, Disulfiram$Strain == "Strain1641")
Strain1642 <- subset(Disulfiram, Disulfiram$Strain == "Strain1642")
Strain1643 <- subset(Disulfiram, Disulfiram$Strain == "Strain1643")
Strain124 <- subset(Disulfiram, Disulfiram$Strain == "Strain124")
StrainB3 <- subset(Disulfiram, Disulfiram$Strain == "StrainB3")
StrainB8 <- subset(Disulfiram, Disulfiram$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Disulfiram for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Disulfiram$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Disulfiram$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Disulfiram$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Disulfiram$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Disulfiram$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Disulfiram$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Disulfiram$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Disulfiram$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Disulfiram$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Disulfiram$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Disulfiram$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Disulfiram$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Disulfiram$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Disulfiram$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Disulfiram$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Disulfiram$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Disulfiram$BackgroundCorrect))
...
#Group Strains By Susceptibility to Disulfiram
```{r}
...
#Model Each Strain for FlucS and Disulfiram
```{r}
...
#Graph the FlucS Strains and Disulfiram#
```{r}
GRAPH_Disulfiram_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Disulfiram (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Disulfiram_S
ggsave(filename="GRAPH-Average_Disulfiram_S.pdf", plot=GRAPH_Disulfiram_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Disulfiram_S <- Table
write.table(Table_Disulfiram_S,"Table_Disulfiram_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Disulfiram
```{r}
FlucM
...
#Graph the FlucM Strains and Disulfiram#
```{r}
GRAPH_Disulfiram_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Disulfiram_M
ggsave(filename="GRAPH-Average_Disulfiram_M.pdf", plot=GRAPH_Disulfiram_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Disulfiram_M <- Table
write.table(Table_Disulfiram_M,"Table_Disulfiram_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Disulfiram
```{r}
FlucR
...
#Graph the FlucR Strains and Disulfiram#
```{r}
GRAPH_Disulfiram_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Disulfiram_R
ggsave(filename="GRAPH-Average_Disulfiram_R.pdf", plot=GRAPH_Disulfiram_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Disulfiram_R <- Table
write.table(Table_Disulfiram_R,"Table_Disulfiram_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Disulfiram Graphs
```{r}
Disulfiram <- grid.arrange(GRAPH_Disulfiram_S,GRAPH_Disulfiram_M,GRAPH_Disulfiram_R, nrow=1, ncol=3)
ggsave("GRAPH-Disulfiram_Fit.pdf", plot=Disulfiram, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Disulfiram_Table <- rbind(Table_Disulfiram_S, Table_Disulfiram_M, Table_Disulfiram_R)
write.table(Disulfiram_Table,"Table_Disulfiram.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Disulfiram_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
