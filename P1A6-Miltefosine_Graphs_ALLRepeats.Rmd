...
Miltefosine <- subset(P1A6_R, P1A6_R$Drug=="Miltefosine" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Miltefosine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Miltefosine, Miltefosine$Strain == "Strain1537")
Strain1538 <- subset(Miltefosine, Miltefosine$Strain == "Strain1538")
Strain1539 <- subset(Miltefosine, Miltefosine$Strain == "Strain1539")
Strain1540 <- subset(Miltefosine, Miltefosine$Strain == "Strain1540")
Strain1541 <- subset(Miltefosine, Miltefosine$Strain == "Strain1541")
Strain1542 <- subset(Miltefosine, Miltefosine$Strain == "Strain1542")
Strain1543 <- subset(Miltefosine, Miltefosine$Strain == "Strain1543")
Strain1544 <- subset(Miltefosine, Miltefosine$Strain == "Strain1544")
Strain1545 <- subset(Miltefosine, Miltefosine$Strain == "Strain1545")
Strain1546 <- subset(Miltefosine, Miltefosine$Strain == "Strain1546")
Strain1641 <- subset(Miltefosine, Miltefosine$Strain == "Strain1641")
Strain1642 <- subset(Miltefosine, Miltefosine$Strain == "Strain1642")
Strain1643 <- subset(Miltefosine, Miltefosine$Strain == "Strain1643")
Strain124 <- subset(Miltefosine, Miltefosine$Strain == "Strain124")
StrainB3 <- subset(Miltefosine, Miltefosine$Strain == "StrainB3")
StrainB8 <- subset(Miltefosine, Miltefosine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Miltefosine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Miltefosine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Miltefosine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Miltefosine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Miltefosine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Miltefosine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Miltefosine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Miltefosine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Miltefosine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Miltefosine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Miltefosine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Miltefosine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Miltefosine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Miltefosine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Miltefosine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Miltefosine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Miltefosine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Miltefosine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Miltefosine
```{r}
...
#Model Each Strain for FlucS and Miltefosine
```{r}
...
#Graph the FlucS Strains and Miltefosine#
```{r}
GRAPH_Miltefosine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-2,2)+
    xlab("Miltefosine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Miltefosine_S
ggsave(filename="GRAPH-Average_Miltefosine_S.pdf", plot=GRAPH_Miltefosine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Miltefosine_S <- Table
write.table(Table_Miltefosine_S,"Table_Miltefosine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Miltefosine
```{r}
FlucM
...
#Graph the FlucM Strains and Miltefosine#
```{r}
GRAPH_Miltefosine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Miltefosine_M
ggsave(filename="GRAPH-Average_Miltefosine_M.pdf", plot=GRAPH_Miltefosine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Miltefosine_M <- Table
write.table(Table_Miltefosine_M,"Table_Miltefosine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Miltefosine
```{r}
FlucR
...
#Graph the FlucR Strains and Miltefosine#
```{r}
GRAPH_Miltefosine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Miltefosine_R
ggsave(filename="GRAPH-Average_Miltefosine_R.pdf", plot=GRAPH_Miltefosine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Miltefosine_R <- Table
write.table(Table_Miltefosine_R,"Table_Miltefosine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Miltefosine Graphs
```{r}
Miltefosine <- grid.arrange(GRAPH_Miltefosine_S,GRAPH_Miltefosine_M,GRAPH_Miltefosine_R, nrow=1, ncol=3)
ggsave("GRAPH-Miltefosine_Fit.pdf", plot=Miltefosine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Miltefosine_Table <- rbind(Table_Miltefosine_S, Table_Miltefosine_M, Table_Miltefosine_R)
write.table(Miltefosine_Table,"Table_Miltefosine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Miltefosine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
