---
title: "P1A6 - Posaconazole Graphs"
...
levels(P1A6_R$Drug)
Posaconazole <- subset(P1A6_R, P1A6_R$Drug=="Posaconazole" & P1A6_R$Concentration>0)# & P1A6_R$Concentration<50)
```
...
#Subset Posaconazole by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Posaconazole, Posaconazole$Strain == "Strain1537")
Strain1538 <- subset(Posaconazole, Posaconazole$Strain == "Strain1538")
Strain1539 <- subset(Posaconazole, Posaconazole$Strain == "Strain1539")
Strain1540 <- subset(Posaconazole, Posaconazole$Strain == "Strain1540")
Strain1541 <- subset(Posaconazole, Posaconazole$Strain == "Strain1541")
Strain1542 <- subset(Posaconazole, Posaconazole$Strain == "Strain1542")
Strain1543 <- subset(Posaconazole, Posaconazole$Strain == "Strain1543")
Strain1544 <- subset(Posaconazole, Posaconazole$Strain == "Strain1544")
Strain1545 <- subset(Posaconazole, Posaconazole$Strain == "Strain1545")
Strain1546 <- subset(Posaconazole, Posaconazole$Strain == "Strain1546")
Strain1641 <- subset(Posaconazole, Posaconazole$Strain == "Strain1641")
Strain1642 <- subset(Posaconazole, Posaconazole$Strain == "Strain1642")
Strain1643 <- subset(Posaconazole, Posaconazole$Strain == "Strain1643")
Strain124 <- subset(Posaconazole, Posaconazole$Strain == "Strain124")
StrainB3 <- subset(Posaconazole, Posaconazole$Strain == "StrainB3")
StrainB8 <- subset(Posaconazole, Posaconazole$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Posaconazole for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Posaconazole$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Posaconazole$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Posaconazole$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Posaconazole$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Posaconazole$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Posaconazole$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Posaconazole$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Posaconazole$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Posaconazole$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Posaconazole$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Posaconazole$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Posaconazole$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Posaconazole$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Posaconazole$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Posaconazole$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Posaconazole$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Posaconazole$BackgroundCorrect))
...
#Group Strains By Susceptibility to Posaconazole
```{r}
...
#Model Each Strain for FlucS and Posaconazole
```{r}
...
#Graph the FlucS Strains and Posaconazole#
```{r}
GRAPH_Posaconazole_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Posaconazole (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Posaconazole_S
ggsave(filename="GRAPH-Average_Posaconazole_S.pdf", plot=GRAPH_Posaconazole_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Posaconazole_S <- Table
write.table(Table_Posaconazole_S,"Table_Posaconazole_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Posaconazole
```{r}
FlucM
...
#Graph the FlucM Strains and Posaconazole#
```{r}
GRAPH_Posaconazole_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Posaconazole_M
ggsave(filename="GRAPH-Average_Posaconazole_M.pdf", plot=GRAPH_Posaconazole_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Posaconazole_M <- Table
write.table(Table_Posaconazole_M,"Table_Posaconazole_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Posaconazole
```{r}
FlucR
...
#Graph the FlucR Strains and Posaconazole#
```{r}
GRAPH_Posaconazole_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Posaconazole_R
ggsave(filename="GRAPH-Average_Posaconazole_R.pdf", plot=GRAPH_Posaconazole_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Posaconazole_R <- Table
write.table(Table_Posaconazole_R,"Table_Posaconazole_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Posaconazole Graphs
```{r}
Posaconazole <- grid.arrange(GRAPH_Posaconazole_S,GRAPH_Posaconazole_M,GRAPH_Posaconazole_R, nrow=1, ncol=3)
ggsave("GRAPH-Posaconazole_Fit.pdf", plot=Posaconazole, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Posaconazole_Table <- rbind(Table_Posaconazole_S, Table_Posaconazole_M, Table_Posaconazole_R)
write.table(Posaconazole_Table,"Table_Posaconazole.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Posaconazole_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
