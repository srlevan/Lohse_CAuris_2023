...
levels(P1A6_R$Drug)
OSU03012 <- subset(P1A6_R, P1A6_R$Drug=="OSU-03012" & P1A6_R$Concentration>0 & P1A6_R$Concentration<50)
```
...
#Subset OSU03012 by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(OSU03012, OSU03012$Strain == "Strain1537")
Strain1538 <- subset(OSU03012, OSU03012$Strain == "Strain1538")
Strain1539 <- subset(OSU03012, OSU03012$Strain == "Strain1539")
Strain1540 <- subset(OSU03012, OSU03012$Strain == "Strain1540")
Strain1541 <- subset(OSU03012, OSU03012$Strain == "Strain1541")
Strain1542 <- subset(OSU03012, OSU03012$Strain == "Strain1542")
Strain1543 <- subset(OSU03012, OSU03012$Strain == "Strain1543")
Strain1544 <- subset(OSU03012, OSU03012$Strain == "Strain1544")
Strain1545 <- subset(OSU03012, OSU03012$Strain == "Strain1545")
Strain1546 <- subset(OSU03012, OSU03012$Strain == "Strain1546")
Strain1641 <- subset(OSU03012, OSU03012$Strain == "Strain1641")
Strain1642 <- subset(OSU03012, OSU03012$Strain == "Strain1642")
Strain1643 <- subset(OSU03012, OSU03012$Strain == "Strain1643")
Strain124 <- subset(OSU03012, OSU03012$Strain == "Strain124")
StrainB3 <- subset(OSU03012, OSU03012$Strain == "StrainB3")
StrainB8 <- subset(OSU03012, OSU03012$Strain == "StrainB8")
```

#Calculate Percent Inhibition for OSU03012 for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(OSU03012$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(OSU03012$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(OSU03012$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(OSU03012$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(OSU03012$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(OSU03012$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(OSU03012$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(OSU03012$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(OSU03012$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(OSU03012$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(OSU03012$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(OSU03012$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(OSU03012$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_Strain124 - min(OSU03012$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(OSU03012$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(OSU03012$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(OSU03012$BackgroundCorrect))
...
#Group Strains By Susceptibility to OSU03012
```{r}
...
#Model Each Strain for FlucS and OSU03012
```{r}
...
#Graph the FlucS Strains and OSU03012#
```{r}
GRAPH_OSU03012_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-2,2)+
    xlab("OSU03012 (uM)") + ylab("Percent Inhibition")+
...
GRAPH_OSU03012_S
ggsave(filename="GRAPH-Average_OSU03012_S.pdf", plot=GRAPH_OSU03012_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_OSU03012_S <- Table
write.table(Table_OSU03012_S,"Table_OSU03012_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and OSU03012
```{r}
FlucM
...
#Graph the FlucM Strains and OSU03012#
```{r}
GRAPH_OSU03012_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_OSU03012_M
ggsave(filename="GRAPH-Average_OSU03012_M.pdf", plot=GRAPH_OSU03012_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_OSU03012_M <- Table
write.table(Table_OSU03012_M,"Table_OSU03012_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and OSU03012
```{r}
FlucR
...
#Graph the FlucR Strains and OSU03012#
```{r}
GRAPH_OSU03012_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_OSU03012_R
ggsave(filename="GRAPH-Average_OSU03012_R.pdf", plot=GRAPH_OSU03012_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_OSU03012_R <- Table
write.table(Table_OSU03012_R,"Table_OSU03012_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All OSU03012 Graphs
```{r}
OSU03012 <- grid.arrange(GRAPH_OSU03012_S,GRAPH_OSU03012_M,GRAPH_OSU03012_R, nrow=1, ncol=3)
ggsave("GRAPH-OSU03012_Fit.pdf", plot=OSU03012, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
OSU03012_Table <- rbind(Table_OSU03012_S, Table_OSU03012_M, Table_OSU03012_R)
write.table(OSU03012_Table,"Table_OSU03012.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "OSU03012_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
