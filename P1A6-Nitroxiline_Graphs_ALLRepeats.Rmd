...
Nitroxiline <- subset(P1A6_R, P1A6_R$Drug=="Nitroxiline" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Nitroxiline by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1537")
Strain1538 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1538")
Strain1539 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1539")
Strain1540 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1540")
Strain1541 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1541")
Strain1542 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1542")
Strain1543 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1543")
Strain1544 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1544")
Strain1545 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1545")
Strain1546 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1546")
Strain1641 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1641")
Strain1642 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1642")
Strain1643 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain1643")
Strain124 <- subset(Nitroxiline, Nitroxiline$Strain == "Strain124")
StrainB3 <- subset(Nitroxiline, Nitroxiline$Strain == "StrainB3")
StrainB8 <- subset(Nitroxiline, Nitroxiline$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Nitroxiline for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Nitroxiline$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Nitroxiline$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Nitroxiline$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Nitroxiline$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Nitroxiline$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Nitroxiline$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Nitroxiline$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Nitroxiline$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Nitroxiline$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Nitroxiline$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Nitroxiline$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Nitroxiline$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Nitroxiline$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Nitroxiline$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Nitroxiline$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Nitroxiline$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Nitroxiline$BackgroundCorrect))
...
#Group Strains By Susceptibility to Nitroxiline
```{r}
...
#Model Each Strain for FlucS and Nitroxiline
```{r}
...
#Graph the FlucS Strains and Nitroxiline#
```{r}
GRAPH_Nitroxiline_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-2,2)+
    xlab("Nitroxiline (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Nitroxiline_S
ggsave(filename="GRAPH-Average_Nitroxiline_S.pdf", plot=GRAPH_Nitroxiline_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Nitroxiline_S <- Table
write.table(Table_Nitroxiline_S,"Table_Nitroxiline_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Nitroxiline
```{r}
FlucM
...
#Graph the FlucM Strains and Nitroxiline#
```{r}
GRAPH_Nitroxiline_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Nitroxiline_M
ggsave(filename="GRAPH-Average_Nitroxiline_M.pdf", plot=GRAPH_Nitroxiline_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Nitroxiline_M <- Table
write.table(Table_Nitroxiline_M,"Table_Nitroxiline_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Nitroxiline
```{r}
FlucR
...
#Graph the FlucR Strains and Nitroxiline#
```{r}
GRAPH_Nitroxiline_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Nitroxiline_R
ggsave(filename="GRAPH-Average_Nitroxiline_R.pdf", plot=GRAPH_Nitroxiline_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Nitroxiline_R <- Table
write.table(Table_Nitroxiline_R,"Table_Nitroxiline_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Nitroxiline Graphs
```{r}
Nitroxiline <- grid.arrange(GRAPH_Nitroxiline_S,GRAPH_Nitroxiline_M,GRAPH_Nitroxiline_R, nrow=1, ncol=3)
ggsave("GRAPH-Nitroxiline_Fit.pdf", plot=Nitroxiline, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Nitroxiline_Table <- rbind(Table_Nitroxiline_S, Table_Nitroxiline_M, Table_Nitroxiline_R)
write.table(Nitroxiline_Table,"Table_Nitroxiline.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Nitroxiline_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
