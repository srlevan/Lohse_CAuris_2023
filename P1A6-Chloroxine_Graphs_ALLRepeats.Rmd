...
Chloroxine <- subset(P1A6_R, P1A6_R$Drug=="Chloroxine" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<21)
```
...
#Subset Chloroxine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Chloroxine, Chloroxine$Strain == "Strain1537")
Strain1538 <- subset(Chloroxine, Chloroxine$Strain == "Strain1538")
Strain1539 <- subset(Chloroxine, Chloroxine$Strain == "Strain1539")
Strain1540 <- subset(Chloroxine, Chloroxine$Strain == "Strain1540")
Strain1541 <- subset(Chloroxine, Chloroxine$Strain == "Strain1541")
Strain1542 <- subset(Chloroxine, Chloroxine$Strain == "Strain1542")
Strain1543 <- subset(Chloroxine, Chloroxine$Strain == "Strain1543")
Strain1544 <- subset(Chloroxine, Chloroxine$Strain == "Strain1544")
Strain1545 <- subset(Chloroxine, Chloroxine$Strain == "Strain1545")
Strain1546 <- subset(Chloroxine, Chloroxine$Strain == "Strain1546")
Strain1641 <- subset(Chloroxine, Chloroxine$Strain == "Strain1641")
Strain1642 <- subset(Chloroxine, Chloroxine$Strain == "Strain1642")
Strain1643 <- subset(Chloroxine, Chloroxine$Strain == "Strain1643")
Strain124 <- subset(Chloroxine, Chloroxine$Strain == "Strain124")
StrainB3 <- subset(Chloroxine, Chloroxine$Strain == "StrainB3")
StrainB8 <- subset(Chloroxine, Chloroxine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Chloroxine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Chloroxine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Chloroxine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Chloroxine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Chloroxine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Chloroxine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Chloroxine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Chloroxine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Chloroxine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Chloroxine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Chloroxine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Chloroxine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Chloroxine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Chloroxine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Chloroxine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Chloroxine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Chloroxine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Chloroxine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Chloroxine
```{r}
...
#Model Each Strain for FlucS and Chloroxine
```{r}
...
#Graph the FlucS Strains and Chloroxine#
```{r}
GRAPH_Chloroxine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Chloroxine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Chloroxine_S
ggsave(filename="GRAPH-Average_Chloroxine_S.pdf", plot=GRAPH_Chloroxine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Chloroxine_S <- Table
write.table(Table_Chloroxine_S,"Table_Chloroxine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Chloroxine
```{r}
FlucM
...
#Graph the FlucM Strains and Chloroxine#
```{r}
GRAPH_Chloroxine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Chloroxine_M
ggsave(filename="GRAPH-Average_Chloroxine_M.pdf", plot=GRAPH_Chloroxine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Chloroxine_M <- Table
write.table(Table_Chloroxine_M,"Table_Chloroxine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Chloroxine
```{r}
FlucR
...
#Graph the FlucR Strains and Chloroxine#
```{r}
GRAPH_Chloroxine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Chloroxine_R
ggsave(filename="GRAPH-Average_Chloroxine_R.pdf", plot=GRAPH_Chloroxine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Chloroxine_R <- Table
write.table(Table_Chloroxine_R,"Table_Chloroxine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Chloroxine Graphs
```{r}
Chloroxine <- grid.arrange(GRAPH_Chloroxine_S,GRAPH_Chloroxine_M,GRAPH_Chloroxine_R, nrow=1, ncol=3)
ggsave("GRAPH-Chloroxine_Fit.pdf", plot=Chloroxine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Chloroxine_Table <- rbind(Table_Chloroxine_S, Table_Chloroxine_M, Table_Chloroxine_R)
write.table(Chloroxine_Table,"Table_Chloroxine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Chloroxine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
