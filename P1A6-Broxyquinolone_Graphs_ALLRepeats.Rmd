---
title: "P1A6 - Broxyquinolone Graphs"
...
Broxyquinolone <- subset(P1A6_R, P1A6_R$Drug=="Broxyquinolone" & P1A6_R$Concentration>0 &P1A6_R$Concentration<21)
```
...
#Subset Broxyquinolone by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1537")
Strain1538 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1538")
Strain1539 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1539")
Strain1540 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1540")
Strain1541 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1541")
Strain1542 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1542")
Strain1543 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1543")
Strain1544 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1544")
Strain1545 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1545")
Strain1546 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1546")
Strain1641 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1641")
Strain1642 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1642")
Strain1643 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain1643")
Strain124 <- subset(Broxyquinolone, Broxyquinolone$Strain == "Strain124")
StrainB3 <- subset(Broxyquinolone, Broxyquinolone$Strain == "StrainB3")
StrainB8 <- subset(Broxyquinolone, Broxyquinolone$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Broxyquinolone for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Broxyquinolone$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Broxyquinolone$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Broxyquinolone$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Broxyquinolone$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Broxyquinolone$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Broxyquinolone$BackgroundCorrect))
...
#Group Strains By Susceptibility to Broxyquinolone
```{r}
...
#Model Each Strain for FlucS and Broxyquinolone
```{r}
...
#Graph the FlucS Strains and Broxyquinolone#
```{r}
GRAPH_Broxyquinolone_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-2,2)+
    xlab("Broxyquinolone (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Broxyquinolone_S
ggsave(filename="GRAPH-Average_Broxyquinolone_S.pdf", plot=GRAPH_Broxyquinolone_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Broxyquinolone_S <- Table
write.table(Table_Broxyquinolone_S,"Table_Broxyquinolone_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Broxyquinolone
```{r}
FlucM
...
#Graph the FlucM Strains and Broxyquinolone#
```{r}
GRAPH_Broxyquinolone_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Broxyquinolone_M
ggsave(filename="GRAPH-Average_Broxyquinolone_M.pdf", plot=GRAPH_Broxyquinolone_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Broxyquinolone_M <- Table
write.table(Table_Broxyquinolone_M,"Table_Broxyquinolone_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Broxyquinolone
```{r}
FlucR
...
#Graph the FlucR Strains and Broxyquinolone#
```{r}
GRAPH_Broxyquinolone_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Broxyquinolone_R
ggsave(filename="GRAPH-Average_Broxyquinolone_R.pdf", plot=GRAPH_Broxyquinolone_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Broxyquinolone_R <- Table
write.table(Table_Broxyquinolone_R,"Table_Broxyquinolone_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Broxyquinolone Graphs
```{r}
Broxyquinolone <- grid.arrange(GRAPH_Broxyquinolone_S,GRAPH_Broxyquinolone_M,GRAPH_Broxyquinolone_R, nrow=1, ncol=3)
ggsave("GRAPH-Broxyquinolone_Fit.pdf", plot=Broxyquinolone, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Broxyquinolone_Table <- rbind(Table_Broxyquinolone_S, Table_Broxyquinolone_M, Table_Broxyquinolone_R)
write.table(Broxyquinolone_Table,"Table_Broxyquinolone.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Broxyquinolone_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
