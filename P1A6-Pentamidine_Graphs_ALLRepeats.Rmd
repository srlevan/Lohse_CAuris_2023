...
levels(P1A6_R$Drug)
Pentamidine <- subset(P1A6_R, P1A6_R$Drug=="Pentamidine" & P1A6_R$Concentration>0)# & P1A6_R$Concentration<50)
```
...
#Subset Pentamidine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Pentamidine, Pentamidine$Strain == "Strain1537")
Strain1538 <- subset(Pentamidine, Pentamidine$Strain == "Strain1538")
Strain1539 <- subset(Pentamidine, Pentamidine$Strain == "Strain1539")
Strain1540 <- subset(Pentamidine, Pentamidine$Strain == "Strain1540")
Strain1541 <- subset(Pentamidine, Pentamidine$Strain == "Strain1541")
Strain1542 <- subset(Pentamidine, Pentamidine$Strain == "Strain1542")
Strain1543 <- subset(Pentamidine, Pentamidine$Strain == "Strain1543")
Strain1544 <- subset(Pentamidine, Pentamidine$Strain == "Strain1544")
Strain1545 <- subset(Pentamidine, Pentamidine$Strain == "Strain1545")
Strain1546 <- subset(Pentamidine, Pentamidine$Strain == "Strain1546")
Strain1641 <- subset(Pentamidine, Pentamidine$Strain == "Strain1641")
Strain1642 <- subset(Pentamidine, Pentamidine$Strain == "Strain1642")
Strain1643 <- subset(Pentamidine, Pentamidine$Strain == "Strain1643")
Strain124 <- subset(Pentamidine, Pentamidine$Strain == "Strain124")
StrainB3 <- subset(Pentamidine, Pentamidine$Strain == "StrainB3")
StrainB8 <- subset(Pentamidine, Pentamidine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Pentamidine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Pentamidine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Pentamidine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Pentamidine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Pentamidine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Pentamidine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Pentamidine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Pentamidine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Pentamidine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Pentamidine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Pentamidine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Pentamidine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Pentamidine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Pentamidine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Pentamidine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Pentamidine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Pentamidine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Pentamidine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Pentamidine
```{r}
...
#Model Each Strain for FlucS and Pentamidine
```{r}
...
#Graph the FlucS Strains and Pentamidine#
```{r}
GRAPH_Pentamidine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-2,3)+
    xlab("Pentamidine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Pentamidine_S
ggsave(filename="GRAPH-Average_Pentamidine_S.pdf", plot=GRAPH_Pentamidine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Pentamidine_S <- Table
write.table(Table_Pentamidine_S,"Table_Pentamidine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Pentamidine
```{r}
FlucM
...
#Graph the FlucM Strains and Pentamidine#
```{r}
GRAPH_Pentamidine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Pentamidine_M
ggsave(filename="GRAPH-Average_Pentamidine_M.pdf", plot=GRAPH_Pentamidine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Pentamidine_M <- Table
write.table(Table_Pentamidine_M,"Table_Pentamidine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Pentamidine
```{r}
FlucR
...
#Graph the FlucR Strains and Pentamidine#
```{r}
GRAPH_Pentamidine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Pentamidine_R
ggsave(filename="GRAPH-Average_Pentamidine_R.pdf", plot=GRAPH_Pentamidine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Pentamidine_R <- Table
write.table(Table_Pentamidine_R,"Table_Pentamidine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Pentamidine Graphs
```{r}
Pentamidine <- grid.arrange(GRAPH_Pentamidine_S,GRAPH_Pentamidine_M,GRAPH_Pentamidine_R, nrow=1, ncol=3)
ggsave("GRAPH-Pentamidine_Fit.pdf", plot=Pentamidine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Pentamidine_Table <- rbind(Table_Pentamidine_S, Table_Pentamidine_M, Table_Pentamidine_R)
write.table(Pentamidine_Table,"Table_Pentamidine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Pentamidine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
