---
title: "P1A6 - Triclabendazole Graphs"
...
levels(P1A6_R$Drug)
Triclabendazole <- subset(P1A6_R, P1A6_R$Drug=="Triclabendazole" & P1A6_R$Concentration>0 & P1A6_R$Concentration<25)
```
...
#Subset Triclabendazole by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1537")
Strain1538 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1538")
Strain1539 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1539")
Strain1540 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1540")
Strain1541 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1541")
Strain1542 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1542")
Strain1543 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1543")
Strain1544 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1544")
Strain1545 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1545")
Strain1546 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1546")
Strain1641 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1641")
Strain1642 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1642")
Strain1643 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain1643")
Strain124 <- subset(Triclabendazole, Triclabendazole$Strain == "Strain124")
StrainB3 <- subset(Triclabendazole, Triclabendazole$Strain == "StrainB3")
StrainB8 <- subset(Triclabendazole, Triclabendazole$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Triclabendazole for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Triclabendazole$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Triclabendazole$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Triclabendazole$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Triclabendazole$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Triclabendazole$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Triclabendazole$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Triclabendazole$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Triclabendazole$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Triclabendazole$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Triclabendazole$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Triclabendazole$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Triclabendazole$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Triclabendazole$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Triclabendazole$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Triclabendazole$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Triclabendazole$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Triclabendazole$BackgroundCorrect))
...
#Group Strains By Susceptibility to Triclabendazole
```{r}
...
#Model Each Strain for FlucS and Triclabendazole
```{r}
...
#Graph the FlucS Strains and Triclabendazole#
```{r}
GRAPH_Triclabendazole_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Triclabendazole (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Triclabendazole_S
ggsave(filename="GRAPH-Average_Triclabendazole_S.pdf", plot=GRAPH_Triclabendazole_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Triclabendazole_S <- Table
write.table(Table_Triclabendazole_S,"Table_Triclabendazole_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Triclabendazole
```{r}
FlucM
...
#Graph the FlucM Strains and Triclabendazole#
```{r}
GRAPH_Triclabendazole_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Triclabendazole_M
ggsave(filename="GRAPH-Average_Triclabendazole_M.pdf", plot=GRAPH_Triclabendazole_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Triclabendazole_M <- Table
write.table(Table_Triclabendazole_M,"Table_Triclabendazole_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Triclabendazole
```{r}
FlucR
...
#Graph the FlucR Strains and Triclabendazole#
```{r}
GRAPH_Triclabendazole_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Triclabendazole_R
ggsave(filename="GRAPH-Average_Triclabendazole_R.pdf", plot=GRAPH_Triclabendazole_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Triclabendazole_R <- Table
write.table(Table_Triclabendazole_R,"Table_Triclabendazole_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Triclabendazole Graphs
```{r}
Triclabendazole <- grid.arrange(GRAPH_Triclabendazole_S,GRAPH_Triclabendazole_M,GRAPH_Triclabendazole_R, nrow=1, ncol=3)
ggsave("GRAPH-Triclabendazole_Fit.pdf", plot=Triclabendazole, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Triclabendazole_Table <- rbind(Table_Triclabendazole_S, Table_Triclabendazole_M, Table_Triclabendazole_R)
write.table(Triclabendazole_Table,"Table_Triclabendazole.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Triclabendazole_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
