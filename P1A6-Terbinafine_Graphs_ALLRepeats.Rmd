...
levels(P1A6_R$Drug)
Terbinafine <- subset(P1A6_R, P1A6_R$Drug=="Terbinafine" & P1A6_R$Concentration>0)# & P1A6_R$Concentration<50)
```
...
#Subset Terbinafine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Terbinafine, Terbinafine$Strain == "Strain1537")
Strain1538 <- subset(Terbinafine, Terbinafine$Strain == "Strain1538")
Strain1539 <- subset(Terbinafine, Terbinafine$Strain == "Strain1539")
Strain1540 <- subset(Terbinafine, Terbinafine$Strain == "Strain1540")
Strain1541 <- subset(Terbinafine, Terbinafine$Strain == "Strain1541")
Strain1542 <- subset(Terbinafine, Terbinafine$Strain == "Strain1542")
Strain1543 <- subset(Terbinafine, Terbinafine$Strain == "Strain1543")
Strain1544 <- subset(Terbinafine, Terbinafine$Strain == "Strain1544")
Strain1545 <- subset(Terbinafine, Terbinafine$Strain == "Strain1545")
Strain1546 <- subset(Terbinafine, Terbinafine$Strain == "Strain1546")
Strain1641 <- subset(Terbinafine, Terbinafine$Strain == "Strain1641")
Strain1642 <- subset(Terbinafine, Terbinafine$Strain == "Strain1642")
Strain1643 <- subset(Terbinafine, Terbinafine$Strain == "Strain1643")
Strain124 <- subset(Terbinafine, Terbinafine$Strain == "Strain124")
StrainB3 <- subset(Terbinafine, Terbinafine$Strain == "StrainB3")
StrainB8 <- subset(Terbinafine, Terbinafine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Terbinafine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Terbinafine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Terbinafine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Terbinafine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Terbinafine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Terbinafine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Terbinafine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Terbinafine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Terbinafine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Terbinafine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Terbinafine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Terbinafine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Terbinafine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Terbinafine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Terbinafine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Terbinafine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Terbinafine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Terbinafine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Terbinafine
```{r}
...
#Model Each Strain for FlucS and Terbinafine
```{r}
...
#Graph the FlucS Strains and Terbinafine#
```{r}
GRAPH_Terbinafine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Terbinafine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Terbinafine_S
ggsave(filename="GRAPH-Average_Terbinafine_S.pdf", plot=GRAPH_Terbinafine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Terbinafine_S <- Table
write.table(Table_Terbinafine_S,"Table_Terbinafine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Terbinafine
```{r}
FlucM
...
#Graph the FlucM Strains and Terbinafine#
```{r}
GRAPH_Terbinafine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Terbinafine_M
ggsave(filename="GRAPH-Average_Terbinafine_M.pdf", plot=GRAPH_Terbinafine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Terbinafine_M <- Table
write.table(Table_Terbinafine_M,"Table_Terbinafine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Terbinafine
```{r}
FlucR
...
#Graph the FlucR Strains and Terbinafine#
```{r}
GRAPH_Terbinafine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Terbinafine_R
ggsave(filename="GRAPH-Average_Terbinafine_R.pdf", plot=GRAPH_Terbinafine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Terbinafine_R <- Table
write.table(Table_Terbinafine_R,"Table_Terbinafine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Terbinafine Graphs
```{r}
Terbinafine <- grid.arrange(GRAPH_Terbinafine_S,GRAPH_Terbinafine_M,GRAPH_Terbinafine_R, nrow=1, ncol=3)
ggsave("GRAPH-Terbinafine_Fit.pdf", plot=Terbinafine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Terbinafine_Table <- rbind(Table_Terbinafine_S, Table_Terbinafine_M, Table_Terbinafine_R)
write.table(Terbinafine_Table,"Table_Terbinafine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Terbinafine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
