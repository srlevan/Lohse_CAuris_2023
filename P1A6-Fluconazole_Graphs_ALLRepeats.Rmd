...
Fluconazole <- subset(P1A6_R, P1A6_R$Drug=="Fluconazole" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Fluconazole by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Fluconazole, Fluconazole$Strain == "Strain1537")
Strain1538 <- subset(Fluconazole, Fluconazole$Strain == "Strain1538")
Strain1539 <- subset(Fluconazole, Fluconazole$Strain == "Strain1539")
Strain1540 <- subset(Fluconazole, Fluconazole$Strain == "Strain1540")
Strain1541 <- subset(Fluconazole, Fluconazole$Strain == "Strain1541")
Strain1542 <- subset(Fluconazole, Fluconazole$Strain == "Strain1542")
Strain1543 <- subset(Fluconazole, Fluconazole$Strain == "Strain1543")
Strain1544 <- subset(Fluconazole, Fluconazole$Strain == "Strain1544")
Strain1545 <- subset(Fluconazole, Fluconazole$Strain == "Strain1545")
Strain1546 <- subset(Fluconazole, Fluconazole$Strain == "Strain1546")
Strain1641 <- subset(Fluconazole, Fluconazole$Strain == "Strain1641")
Strain1642 <- subset(Fluconazole, Fluconazole$Strain == "Strain1642")
Strain1643 <- subset(Fluconazole, Fluconazole$Strain == "Strain1643")
Strain124 <- subset(Fluconazole, Fluconazole$Strain == "Strain124")
StrainB3 <- subset(Fluconazole, Fluconazole$Strain == "StrainB3")
StrainB8 <- subset(Fluconazole, Fluconazole$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Fluconazole for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Fluconazole$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Fluconazole$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Fluconazole$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Fluconazole$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Fluconazole$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Fluconazole$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Fluconazole$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Fluconazole$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Fluconazole$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Fluconazole$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Fluconazole$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Fluconazole$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Fluconazole$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Fluconazole$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Fluconazole$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Fluconazole$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Fluconazole$BackgroundCorrect))
...
#Group Strains By Susceptibility to Fluconazole
```{r}
...
#Model Each Strain for FlucS and Fluconazole
```{r}
...
#Graph the FlucS Strains and Fluconazole#
```{r}
GRAPH_Fluconazole_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,4)+
    xlab("Fluconazole (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Fluconazole_S
ggsave(filename="GRAPH-Average_Fluconazole_S.pdf", plot=GRAPH_Fluconazole_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Fluconazole_S <- Table
write.table(Table_Fluconazole_S,"Table_Fluconazole_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Fluconazole
```{r}
FlucM
...
#Graph the FlucM Strains and Fluconazole#
```{r}
GRAPH_Fluconazole_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Fluconazole_M
ggsave(filename="GRAPH-Average_Fluconazole_M.pdf", plot=GRAPH_Fluconazole_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Fluconazole_M <- Table
write.table(Table_Fluconazole_M,"Table_Fluconazole_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Fluconazole
```{r}
FlucR
...
#Graph the FlucR Strains and Fluconazole#
```{r}
GRAPH_Fluconazole_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Fluconazole_R
ggsave(filename="GRAPH-Average_Fluconazole_R.pdf", plot=GRAPH_Fluconazole_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Fluconazole_R <- Table
write.table(Table_Fluconazole_R,"Table_Fluconazole_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Fluconazole Graphs
```{r}
Fluconazole <- grid.arrange(GRAPH_Fluconazole_S,GRAPH_Fluconazole_M,GRAPH_Fluconazole_R, nrow=1, ncol=3)
ggsave("GRAPH-Fluconazole_Fit.pdf", plot=Fluconazole, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Fluconazole_Table <- rbind(Table_Fluconazole_S, Table_Fluconazole_M, Table_Fluconazole_R)
write.table(Fluconazole_Table,"Table_Fluconazole.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Fluconazole_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
