---
title: "P1A6 - Amphotericine Graphs"
...
Amphotericine <- subset(P1A6_R, P1A6_R$Drug=="Amphotericine" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<21)
```
...
#Subset Amphotericine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Amphotericine, Amphotericine$Strain == "Strain1537")
Strain1538 <- subset(Amphotericine, Amphotericine$Strain == "Strain1538")
Strain1539 <- subset(Amphotericine, Amphotericine$Strain == "Strain1539")
Strain1540 <- subset(Amphotericine, Amphotericine$Strain == "Strain1540")
Strain1541 <- subset(Amphotericine, Amphotericine$Strain == "Strain1541")
Strain1542 <- subset(Amphotericine, Amphotericine$Strain == "Strain1542")
Strain1543 <- subset(Amphotericine, Amphotericine$Strain == "Strain1543")
Strain1544 <- subset(Amphotericine, Amphotericine$Strain == "Strain1544")
Strain1545 <- subset(Amphotericine, Amphotericine$Strain == "Strain1545")
Strain1546 <- subset(Amphotericine, Amphotericine$Strain == "Strain1546")
Strain1641 <- subset(Amphotericine, Amphotericine$Strain == "Strain1641")
Strain1642 <- subset(Amphotericine, Amphotericine$Strain == "Strain1642")
Strain1643 <- subset(Amphotericine, Amphotericine$Strain == "Strain1643")
Strain124 <- subset(Amphotericine, Amphotericine$Strain == "Strain124")
StrainB3 <- subset(Amphotericine, Amphotericine$Strain == "StrainB3")
StrainB8 <- subset(Amphotericine, Amphotericine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Amphotericine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Amphotericine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Amphotericine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Amphotericine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Amphotericine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Amphotericine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Amphotericine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Amphotericine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Amphotericine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Amphotericine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Amphotericine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Amphotericine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Amphotericine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Amphotericine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Amphotericine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Amphotericine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Amphotericine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Amphotericine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Amphotericine
```{r}
...
#Model Each Strain for FlucS and Amphotericine
```{r}
...
#Graph the FlucS Strains and Amphotericine#
```{r}
GRAPH_Amphotericine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,2)+
    xlab("Amphotericine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Amphotericine_S
ggsave(filename="GRAPH-Average_Amphotericine_S.pdf", plot=GRAPH_Amphotericine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Amphotericine_S <- Table
write.table(Table_Amphotericine_S,"Table_Amphotericine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Amphotericine
```{r}
FlucM
...
#Graph the FlucM Strains and Amphotericine#
```{r}
GRAPH_Amphotericine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Amphotericine_M
ggsave(filename="GRAPH-Average_Amphotericine_M.pdf", plot=GRAPH_Amphotericine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Amphotericine_M <- Table
write.table(Table_Amphotericine_M,"Table_Amphotericine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Amphotericine
```{r}
FlucR
...
#Graph the FlucR Strains and Amphotericine#
```{r}
GRAPH_Amphotericine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())
GRAPH_Amphotericine_R
ggsave(filename="GRAPH-Average_Amphotericine_R.pdf", plot=GRAPH_Amphotericine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Amphotericine_R <- Table
write.table(Table_Amphotericine_R,"Table_Amphotericine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Amphotericine Graphs
```{r}
Amphotericine <- grid.arrange(GRAPH_Amphotericine_S,GRAPH_Amphotericine_M,GRAPH_Amphotericine_R, nrow=1, ncol=3)
ggsave("GRAPH-Amphotericine_Fit.pdf", plot=Amphotericine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Amphotericine_Table <- rbind(Table_Amphotericine_S, Table_Amphotericine_M, Table_Amphotericine_R)
write.table(Amphotericine_Table,"Table_Amphotericine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Amphotericine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
