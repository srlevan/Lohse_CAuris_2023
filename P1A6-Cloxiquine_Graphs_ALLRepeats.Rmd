...
Cloxiquine <- subset(P1A6_R, P1A6_R$Drug=="Cloxiquine" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<15)
```
...
#Subset Cloxiquine by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1537")
Strain1538 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1538")
Strain1539 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1539")
Strain1540 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1540")
Strain1541 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1541")
Strain1542 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1542")
Strain1543 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1543")
Strain1544 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1544")
Strain1545 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1545")
Strain1546 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1546")
Strain1641 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1641")
Strain1642 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1642")
Strain1643 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain1643")
Strain124 <- subset(Cloxiquine, Cloxiquine$Strain == "Strain124")
StrainB3 <- subset(Cloxiquine, Cloxiquine$Strain == "StrainB3")
StrainB8 <- subset(Cloxiquine, Cloxiquine$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Cloxiquine for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Cloxiquine$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Cloxiquine$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Cloxiquine$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Cloxiquine$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Cloxiquine$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Cloxiquine$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Cloxiquine$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Cloxiquine$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Cloxiquine$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Cloxiquine$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Cloxiquine$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Cloxiquine$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Cloxiquine$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Cloxiquine$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Cloxiquine$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Cloxiquine$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Cloxiquine$BackgroundCorrect))
...
#Group Strains By Susceptibility to Cloxiquine
```{r}
...
#Model Each Strain for FlucS and Cloxiquine
```{r}
...
#Graph the FlucS Strains and Cloxiquine#
```{r}
GRAPH_Cloxiquine_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Cloxiquine (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Cloxiquine_S
ggsave(filename="GRAPH-Average_Cloxiquine_S.pdf", plot=GRAPH_Cloxiquine_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Cloxiquine_S <- Table
write.table(Table_Cloxiquine_S,"Table_Cloxiquine_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Cloxiquine
```{r}
FlucM
...
#Graph the FlucM Strains and Cloxiquine#
```{r}
GRAPH_Cloxiquine_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Cloxiquine_M
ggsave(filename="GRAPH-Average_Cloxiquine_M.pdf", plot=GRAPH_Cloxiquine_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Cloxiquine_M <- Table
write.table(Table_Cloxiquine_M,"Table_Cloxiquine_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Cloxiquine
```{r}
FlucR
...
#Graph the FlucR Strains and Cloxiquine#
```{r}
GRAPH_Cloxiquine_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Cloxiquine_R
ggsave(filename="GRAPH-Average_Cloxiquine_R.pdf", plot=GRAPH_Cloxiquine_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Cloxiquine_R <- Table
write.table(Table_Cloxiquine_R,"Table_Cloxiquine_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Cloxiquine Graphs
```{r}
Cloxiquine <- grid.arrange(GRAPH_Cloxiquine_S,GRAPH_Cloxiquine_M,GRAPH_Cloxiquine_R, nrow=1, ncol=3)
ggsave("GRAPH-Cloxiquine_Fit.pdf", plot=Cloxiquine, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Cloxiquine_Table <- rbind(Table_Cloxiquine_S, Table_Cloxiquine_M, Table_Cloxiquine_R)
write.table(Cloxiquine_Table,"Table_Cloxiquine.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Cloxiquine_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
