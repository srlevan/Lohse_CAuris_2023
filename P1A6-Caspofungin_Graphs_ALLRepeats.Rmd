...
Caspofungin <- subset(P1A6_R, P1A6_R$Drug=="Caspofungin" & P1A6_R$Concentration>0) # & P1A6_R$Concentration<21)
```
...
#Subset Caspofungin by Strain#
```{r}
#Begin by Subsetting Data by Strain#
Strain1537 <- subset(Caspofungin, Caspofungin$Strain == "Strain1537")
Strain1538 <- subset(Caspofungin, Caspofungin$Strain == "Strain1538")
Strain1539 <- subset(Caspofungin, Caspofungin$Strain == "Strain1539")
Strain1540 <- subset(Caspofungin, Caspofungin$Strain == "Strain1540")
Strain1541 <- subset(Caspofungin, Caspofungin$Strain == "Strain1541")
Strain1542 <- subset(Caspofungin, Caspofungin$Strain == "Strain1542")
Strain1543 <- subset(Caspofungin, Caspofungin$Strain == "Strain1543")
Strain1544 <- subset(Caspofungin, Caspofungin$Strain == "Strain1544")
Strain1545 <- subset(Caspofungin, Caspofungin$Strain == "Strain1545")
Strain1546 <- subset(Caspofungin, Caspofungin$Strain == "Strain1546")
Strain1641 <- subset(Caspofungin, Caspofungin$Strain == "Strain1641")
Strain1642 <- subset(Caspofungin, Caspofungin$Strain == "Strain1642")
Strain1643 <- subset(Caspofungin, Caspofungin$Strain == "Strain1643")
Strain124 <- subset(Caspofungin, Caspofungin$Strain == "Strain124")
StrainB3 <- subset(Caspofungin, Caspofungin$Strain == "StrainB3")
StrainB8 <- subset(Caspofungin, Caspofungin$Strain == "StrainB8")
```

#Calculate Percent Inhibition for Caspofungin for Each Strain using DMSO_mean_Strain#
```{r}
Strain1537$PercentInhib <- 1-(Strain1537$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1537 - min(Caspofungin$BackgroundCorrect))
...
Strain1538$PercentInhib <- 1-(Strain1538$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1538 - min(Caspofungin$BackgroundCorrect))
...
Strain1539$PercentInhib <- 1-(Strain1539$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1539 - min(Caspofungin$BackgroundCorrect))
...
Strain1540$PercentInhib <- 1-(Strain1540$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1540 - min(Caspofungin$BackgroundCorrect))
...
Strain1541$PercentInhib <- 1-(Strain1541$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1541 - min(Caspofungin$BackgroundCorrect))
...
Strain1542$PercentInhib <- 1-(Strain1542$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1542 - min(Caspofungin$BackgroundCorrect))
...
Strain1543$PercentInhib <- 1-(Strain1543$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1543 - min(Caspofungin$BackgroundCorrect))
...
Strain1544$PercentInhib <- 1-(Strain1544$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1544 - min(Caspofungin$BackgroundCorrect))
...
Strain1545$PercentInhib <- 1-(Strain1545$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1545 - min(Caspofungin$BackgroundCorrect))
...
Strain1546$PercentInhib <- 1-(Strain1546$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1546 - min(Caspofungin$BackgroundCorrect))
...
Strain1641$PercentInhib <- 1-(Strain1641$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1641 - min(Caspofungin$BackgroundCorrect))
...
Strain1642$PercentInhib <- 1-(Strain1642$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1642 - min(Caspofungin$BackgroundCorrect))
...
Strain1643$PercentInhib <- 1-(Strain1643$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain1643 - min(Caspofungin$BackgroundCorrect))
...
Strain124$PercentInhib <- 1-(Strain124$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_Strain124 - min(Caspofungin$BackgroundCorrect))
...
StrainB3$PercentInhib <- 1-(StrainB3$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_StrainB3 - min(Caspofungin$BackgroundCorrect))
...
StrainB8$PercentInhib <- 1-(StrainB8$BackgroundCorrect - min(Caspofungin$BackgroundCorrect))/(DMSO_mean_StrainB8 - min(Caspofungin$BackgroundCorrect))
...
#Group Strains By Susceptibility to Caspofungin
```{r}
...
#Model Each Strain for FlucS and Caspofungin
```{r}
...
#Graph the FlucS Strains and Caspofungin#
```{r}
GRAPH_Caspofungin_S <- ggplot(Strain1537_Summary)+
    ...
    ylim(-0.35,1.25)+
    xlim(-3,3)+
    xlab("Caspofungin (uM)") + ylab("Percent Inhibition")+
...
GRAPH_Caspofungin_S
ggsave(filename="GRAPH-Average_Caspofungin_S.pdf", plot=GRAPH_Caspofungin_S, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Caspofungin_S <- Table
write.table(Table_Caspofungin_S,"Table_Caspofungin_S.txt", sep="\t", quote=F, row.names = F)

```

#Model Each Strain for FlucM and Caspofungin
```{r}
FlucM
...
#Graph the FlucM Strains and Caspofungin#
```{r}
GRAPH_Caspofungin_M <- ggplot(Strain1539_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Caspofungin_M
ggsave(filename="GRAPH-Average_Caspofungin_M.pdf", plot=GRAPH_Caspofungin_M, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Caspofungin_M <- Table
write.table(Table_Caspofungin_M,"Table_Caspofungin_M.txt", sep="\t", quote=F, row.names = F)
```

#Model Each Strain for FlucR and Caspofungin
```{r}
FlucR
...
#Graph the FlucR Strains and Caspofungin#
```{r}
GRAPH_Caspofungin_R <- ggplot(Strain1541_Summary)+
    ...
    theme(axis.line = element_line(colour = "black"),
        ...
        panel.background = element_blank())
GRAPH_Caspofungin_R
ggsave(filename="GRAPH-Average_Caspofungin_R.pdf", plot=GRAPH_Caspofungin_R, useDingbats=FALSE, width=11, height=8.5, units="in")
...
Table_Caspofungin_R <- Table
write.table(Table_Caspofungin_R,"Table_Caspofungin_R.txt", sep="\t", quote=F, row.names = F)
```

Arrange All Caspofungin Graphs
```{r}
Caspofungin <- grid.arrange(GRAPH_Caspofungin_S,GRAPH_Caspofungin_M,GRAPH_Caspofungin_R, nrow=1, ncol=3)
ggsave("GRAPH-Caspofungin_Fit.pdf", plot=Caspofungin, useDingbats=FALSE, width=11, height=2.5, units="in")
```

Combine all Tables
```{r}
Caspofungin_Table <- rbind(Table_Caspofungin_S, Table_Caspofungin_M, Table_Caspofungin_R)
write.table(Caspofungin_Table,"Table_Caspofungin.txt", sep="\t", quote=F, row.names = F)
...
write.table(Strains_Wide, "Caspofungin_Strains_Wide.txt", sep="\t", row.names=F, quote=F)
```
